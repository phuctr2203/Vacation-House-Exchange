...
void requestSearchHouse(vector<House> houseList, Member currentMem) {
    ...
    cout << "Request house successfully! :D" << endl;
...
void deleteRequest(string occupier_name) {
    ...
    if (is_empty_file("request.txt") == true) {
        cout << "You have not request any house" << endl;
    } else {
        do {
            if(count == 0) {
...
void acceptRequest(string owner_name) {
    ...
    if(is_empty_file("request.txt") == true) {
        cout << "No one has request your house yet! :<" << endl;
    } else {
        do {
            if(count == 0) {
        ...
        cout << "\nAccept Occupy Successful! :D" << endl;
    }
}
